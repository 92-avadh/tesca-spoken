  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <Link href="/" className="sm-logo" aria-label="Logo" onClick={closeMenu}>
          <img
            src={logoUrl || '/Tesca_logo.png'}
            alt="Logo"
            ...
            {items && items.length ? (
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  {it.link && it.link.startsWith('http') ? (
                    <a
                    ...
                    <button
                      type="button"
                      className="sm-panel-item text-left w-full border-none bg-transparent cursor-pointer font-semibold outline-none"
                      onClick={() => {
                        it.onClick?.();
                        closeMenu();
                      }}
